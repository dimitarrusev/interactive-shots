...
import { todoDashboardV2ShotAnimation } from './todo-dashboard-v2.animations';
...
export class TodoDashboardV2Component implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    // Build animations
    this.shotAnimation = this.buildAnimationPlayer(this.shotRef, todoDashboardV2ShotAnimation());
